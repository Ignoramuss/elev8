...
/**
 * Abstract base class for managing read-only namespace-scoped Kubernetes resources.
 * Read-only resources (like PodMetrics from the Metrics API) do not support
 ...
 */
public abstract class AbstractReadOnlyResourceManager<T extends KubernetesResource>
    ...
    protected AbstractReadOnlyResourceManager(final KubernetesClient client,
